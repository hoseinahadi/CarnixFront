...
const outputDir = "D:/Project/Front/Next/New folder/outputs/audit-progress";
const outputPath = `${outputDir}/CARNIX_UI_AUDIT_PROGRESS.xlsx`;
const wb = await SpreadsheetFile.importXlsx(await FileBlob.load(inputPath));

const scores = {
  "ایرادات فنی و منطقی": [0, 70, 100, 90, 0, 100, 100, 60, 100, 0, 0, 0, 20, 40, 80, 60, 100, 0, 100, 30, 0, 70, 70, 0, 100, 0, 0, 100, 80, 100, 40, 60, 0, 0, 0, 0],
